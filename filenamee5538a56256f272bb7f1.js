...
var Search = /*#__PURE__*/function () {
  ...
  return _createClass(Search, [{
    key: "searchUsers",
    value: function () {
      var _searchUsers = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var _this = this;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return fetch("http://api.github.com/search/users?q=".concat(this.view.searchInput.value)).then(function (res) {
                if (res.ok) {
                  res.json().then(function (res) {
                    res.items.forEach(function (user) {
                      return _this.view.createUser(user);
                    });
                  });
                } else {
