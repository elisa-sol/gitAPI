...
var View = /*#__PURE__*/function () {
  ...
  return _createClass(View, [{
    key: "createElement",
    value: function createElement(elementTag, elementClass) {
...
function _defineProperty(obj, key, value) { key = search_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var Search = /*#__PURE__*/function () {
  function Search(view) {
    ...
    _defineProperty(this, "debounce", function (fn, debounceTime) {
      var timeout;
      return function () {
  ...
  return search_createClass(Search, [{
    key: "loadRepositories",
    value: function () {
      var _loadRepositories = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var _this2 = this;
        var searchValue, res, data;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              searchValue = this.view.searchInput.value.trim();
              if (!searchValue) {
                _context.next = 19;
                break;
              }
              ...
              _context.prev = 3;
              _context.next = 6;
              return fetch("https://api.github.com/search/repositories?q=".concat(searchValue, "&per_page=").concat(userPerPage));
            case 6:
              res = _context.sent;
              if (!res.ok) {
                _context.next = 12;
            ...
            case 10:
              ...
              data.items.forEach(function (repo) {
                return _this2.view.createDropdownItem(repo);
              });
            case 12:
              _context.next = 17;
              break;
            case 14:
              ...
              console.error('Error fetching repositories:', _context.t0);
            case 17:
              _context.next = 20;
              break;
            case 19:
      ...
      function loadRepositories() {
        return _loadRepositories.apply(this, arguments);
      }
