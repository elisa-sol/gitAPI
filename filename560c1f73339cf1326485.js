...
var View = /*#__PURE__*/function () {
  ...
  return _createClass(View, [{
    ...
    value: function createUser(userData) {
      var userElement = this.createElement('li', 'userPrev');
      userElement.innerHTML = "<span class = \"userPrevName\">".concat(userData.login, "</span>");
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return fetch("http://api.github.com/search/users?q=".concat(this.view.searchInput.value, "&per_page=").concat(userPerPage, "&page=").concat(this.currentPage)).then(function (res) {
                if (res.ok) {
                  _this2.setCurrentPage(_this2.currentPage + 1);
                  res.json().then(function (res) {
                    res.items.forEach(function (user) {
                      return _this2.view.createUser(user);
                    });
                  });
                } else {
                  // console.log('Error fetching users');
